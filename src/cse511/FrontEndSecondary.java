...
public class FrontEndSecondary {
...
class FrontEndSecondaryService implements Runnable{
	Socket socket;
	public FrontEndSecondaryService(Socket socket){
		this.socket = socket;
	}
	public void run(){
		try {
...
//			while (true) {
//				System.out.println("front-end secondary is running");
